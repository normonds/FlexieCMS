		...
		retMap.forEach((val:string, key:string) => {
			...
			// if (catIDsCell.get(key)) {
				if (val.split('.').length==1) {
					strSpace = String.fromCharCode(160) + String.fromCharCode(160) + String.fromCharCode(160)+ '↑ ';
					...
					strSpace = val.replace(/./g, String.fromCharCode(160) + String.fromCharCode(160) + String.fromCharCode(160)) + '↑ ';
